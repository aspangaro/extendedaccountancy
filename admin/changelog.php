...
/**
 *	    \file       htdocs/extendedaccountancy/admin/about.php
 *		\ingroup    extendedaccountancy
 *		\brief      Page about of extendedaccountancy module
 */
...
dol_include_once('/extendedaccountancy/lib/opendsi_common.lib.php');
...
dol_fiche_head($head, 'changelog', $langs->trans("Module163054Name"), 0, 'action');

$changelog = opendsi_common_getChangeLog('extendedaccountancy');
